...
class PostController extends AbstractController
{
    ...
    {
        $posts = $paginator->paginate($postRepository->findByAll(), $request->query->getInt('page', 1), 10);
    ...
    {
        //* Si je n'ai pas encore liker alors je rajoute like sinon je l'enlève.
        //* Sachant que Like n'est pas une entité, il suffira de modifier l'array like[] du post pour ajouter l'utilisateur.
